-- aggregation of data in the first 1-day, 2-day and 3-day
-- this query shows an example of the first 1-day

DROP TABLE IF EXISTS mp_data_1day CASCADE;
CREATE TABLE mp_data_1day as
